...
/*
 * Targeting Fundamental problem the empty SSList has a null first, we cannot
 * access first.next! Solution1: a special case; Solution2: make all SSLists the
 * same,even the empty one! create a node that is always there, the sentinel
 * node, the empty SSList will point to the sentinel node rather than the null
 * node;
 */